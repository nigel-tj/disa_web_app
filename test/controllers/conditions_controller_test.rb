...
class ConditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post conditions_url, params: { condition: { age: @condition.age, gender: @condition.gender, latitude: @condition.latitude, longitude: @condition.longitude, name: @condition.name, status: @condition.status } }
    end
  ...
  test "should update condition" do
    patch condition_url(@condition), params: { condition: { age: @condition.age, gender: @condition.gender, latitude: @condition.latitude, longitude: @condition.longitude, name: @condition.name, status: @condition.status } }
